...
return [
    ...
    'settings' => [
        'default' => [
            ...
            'HTML.Allowed' => 'div[class|id|data-bs-parent|data-bs-target|data-bs-toggle|aria-expanded|aria-controls|aria-labelledby],b,strong,i,em,u,a[href|title|class|id|target|rel],ul[class|id],ol[class|id],li[class|id],p[style|class|id],br,span[style|class|id],img[width|height|alt|src|class|id|style],h1[class|id|style],h2[class|id|style],h3[class|id|style],h4[class|id|style],h5[class|id|style],h6[class|id|style],blockquote[class|id|style],button[class|id|data-bs-toggle|data-bs-target|aria-expanded|aria-controls]',
