...
return [
    ...
    // Quick Facts Section
    'quick_facts_title' => 'Toulouse 2026 at a Glance',
    'quick_facts' => [
        [
            'label' => 'Average Monthly Cost',
            'value' => '€1,150 – €1,500 (Aerospace & Tech Hub)',
        ],
        [
            'label' => 'CAF Housing Subsidy (APL)',
            'value' => 'Up to 30% – 40% of rent (~€180–€300/mo)',
        ],
        [
        ...
        [
            ...
            'value' => 'French (B2) / English (Engineering & Business Masters)',
        ],
    ],
    ...
    // CTA Banner
    'cta_banner_title' => 'Ready to Start Your Journey to Study and Live in Toulouse?',
    'cta_banner_subtitle' => 'Book a dedicated consultation session with A.V.C experts and get your customized 2026 Toulouse roadmap.',
