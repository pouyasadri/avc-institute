...
return [
    ...
    'duration_10_months' => '10 Mois (Année universitaire)',
    'duration_12_months' => '12 Mois (Année complète VLS-TS)',
    ...
    'caf_subsidy_title' => 'Aide au Logement de la CAF (APL)',
    'caf_subsidy_desc' => 'Subvention mensuelle versée directement sur le compte bancaire de l’étudiant après son arrivée en France.',
    'net_monthly_title' => 'Budget Mensuel Réel (Après déduction de l’aide CAF)',
    'first_year_total_title' => 'Budget Total Estimé 1ère Année (Vie + Scolarité)',

    // Breakdown items
    'breakdown_title' => 'Détail des dépenses mensuelles estimées :',
    'item_rent' => 'Loyer (brut avant APL)',
    'item_food' => 'Alimentation & courses courantes',
    'item_transport' => 'Abonnement transports en commun étudiant',
