@extends('layout')
@section('title', __('Create Property'))
@section('content')
    <div class="page-title-area">
        <div class="container">
            <div class="page-title-content">
                <h2>{{ __('Create Property') }}</h2>
                <ul>
            ...
            <form action="{{ $storeAction }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="country" name="country"
                                           value="{{ old('country', 'FR') }}" maxlength="2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control tinymce"
                                                  ...
                                                  rows="10"
                                                  {{ $index === 0 ? 'required' : '' }}>{{ old("translations.{$index}.description") }}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="text-right">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bx bx-save"></i> {{ __('Create Property') }}
                    </button>
                </div>
            </form>
        </div>
