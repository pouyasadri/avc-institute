...
@section('city_content')
    ...
    @if(is_array(__('city/bordeaux.quick_facts')))
        <div class="card border-0 shadow-sm rounded-4 mb-5 bg-light">
            <div class="card-body p-4">
                <h3 class="h5 fw-bold text-primary mb-3 d-flex align-items-center">
                    ...
                    {{ __('city/bordeaux.quick_facts_title') }}
                </h3>
                <div class="row g-3">
                    @foreach (__('city/bordeaux.quick_facts') as $item)
    ...
    <section class="mb-5">
        ...
        <ul class="list-group list-group-flush mb-4">
            <li class="list-group-item bg-transparent border-0 ps-0">
                ...
                <a href="{{ url($currentLocale . '/universities/universite-de-bordeaux') }}">{{ __('city/bordeaux.university_bordeaux') }}</a>
            </li>
        </ul>
    </section>
    ...
    <div class="cta-consult-banner my-5 py-4 px-4 px-md-5 rounded-5 shadow-sm text-center text-md-start bg-primary text-white position-relative overflow-hidden">
        <div class="row align-items-center position-relative" style="z-index: 2;">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <h3 class="h4 fw-bold text-white mb-2">{{ __('city/bordeaux.cta_banner_title') }}</h3>
                <p class="mb-0 text-white-50 fs-6">{{ __('city/bordeaux.cta_banner_subtitle') }}</p>
            </div>
            <div class="col-lg-4 text-center text-lg-end">
                <a href="{{ url($currentLocale . '/consult') }}" class="btn btn-light btn-lg rounded-pill fw-bold px-4 py-3 text-primary shadow-sm">
                    ...
                    {{ __('city/bordeaux.cta_banner_button') }}
                </a>
            </div>
        </div>
    </div>
